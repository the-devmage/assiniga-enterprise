...
export default function AppLayout() {
  ...
  return (
    <div className="bg-[#E0E7E9] md:grid md:grid-cols-12 h-[100vh] md:pr-10 md:py-8 relative">
      ...
      <main className="md:col-span-10 h-[100%] border border-[#0C4A60] pt-2 overflow-scroll">
        <header className="pb-2 px-4 w-full flex justify-center items-center gap-20 border border-b-[#0C4A60] relative mt-16 md:mt-0">
